  ...
  return (
    <>
      <SEO
        ...
        description="The code of conduct that is expected to be followed by anyone contributing to the project."
      ...
      <section className="space-y-6 pb-8 lg:pb-14">
        ...
        <div className="space-y-3">
          ...
          <p>
            ...
            at{" "}
            <Link href="mailto:root@krypton.ninja" external>
              <InlineCodeblock>root@krypton.ninja</InlineCodeblock>
            </Link>
        ...
        <div className="space-y-3">
          ...
          <p>
            ...
            <Link href="https://www.contributor-covenant.org" external>
          ...
          <p>
            ...
            FAQ at{" "}
            <Link href="https://www.contributor-covenant.org/faq" external>
